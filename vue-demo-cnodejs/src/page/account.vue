<template>
  <div id="account">
      ...
      <!--<router-link to="/">-->
        <mt-button class="aInfo largeBtn" type="primary" @click.native="recharge">充值</mt-button>
      <!--</router-link>-->
  </div>
</template>
...
<style type="text/css" scoped>
  .aTitle{margin: 10% auto;text-align: center;position: relative;}
  .aInfo{font-size: 18px;margin-bottom: 20px;}
  .priceTag {float: left;width: 15%;height: 2%;margin: 2% 2.5%;border: 1px solid #e2e2e2;vertical-align: middle;padding: 5px 0;}
</style>
